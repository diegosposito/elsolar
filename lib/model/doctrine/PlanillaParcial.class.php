 ...
 */
class PlanillaParcial extends PDF 
{
  //********** Funcion Esquema Examen Parcial*************
  public function EsquemaPlanillaParcial1eraHoja($bucles)
  {  
	//	ESQUEMA GRÁFICO
	...
	$this->Line(80,36,80,284);
	$this->Line(100,56,100,284);
	$this->Line(120,56,120,284);
	$this->Line(140,56,140,284);
	...
	$this->SetXY(80,59);
	$this->Cell(20,10,"1er. Parcial",0,1,'C');
	$this->SetXY(100,59);
	$this->Cell(20,10,"Recuperatorio",0,1,'C');
	$this->SetXY(120,59);
	$this->Cell(20,10,"2do. Parcial",0,1,'C');
	$this->SetXY(140,59);
	$this->Cell(20,10,"Recuperatorio",0,1,'C');
	$this->SetXY(160,59);
  ...
  //********** Funcion Esquema Examen Parcial*************
  public function EsquemaPlanillaParcial2daHoja($aux)
  {  
	...
	$this->SetXY(80,$aux);
	$this->Cell(20,5,"1er. Parcial",0,1,'C');
	$this->SetXY(100,$aux);
	$this->Cell(20,5,"Recuperatorio",0,1,'C');
	$this->SetXY(120,$aux);
	$this->Cell(20,5,"2do. Parcial",0,1,'C');
	$this->SetXY(140,$aux);
	$this->Cell(20,5,"Recuperatorio",0,1,'C');
	$this->SetXY(160,$aux);
