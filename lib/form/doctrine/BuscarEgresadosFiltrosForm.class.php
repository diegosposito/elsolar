<?php
class BuscarEgresadosFiltrosForm extends sfForm
{
  ...
  {  	
	...
	$arregloOrdenCampo = array('s.nombre' => 'Sede','f.nombre' => 'Facultad','c.nombre' => 'Carrera','ea.fecha' => 'Fecha de egreso');
	...
	$this->widgetSchema['idestado'] = new sfWidgetFormSelect(array('label' => '<p align="left"><b>Estado:</b></p>', 'choices' => $arregloEstados));
