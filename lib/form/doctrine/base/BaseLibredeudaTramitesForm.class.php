...
/**
 * LibredeudaTramites form base class.
 *
 * @method LibredeudaTramites getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseLibredeudaTramitesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('libredeuda_tramites[%s]');
