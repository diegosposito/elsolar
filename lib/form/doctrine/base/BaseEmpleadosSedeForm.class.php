...
/**
 * EmpleadosSede form base class.
 *
 * @method EmpleadosSede getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseEmpleadosSedeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'         => new sfWidgetFormInputHidden(),
      'idempleado' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Empleados'), 'add_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('empleados_sede[%s]');
