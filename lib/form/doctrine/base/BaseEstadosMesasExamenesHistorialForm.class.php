...
/**
 * EstadosMesasExamenesHistorial form base class.
 *
 * @method EstadosMesasExamenesHistorial getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseEstadosMesasExamenesHistorialForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('estados_mesas_examenes_historial[%s]');
