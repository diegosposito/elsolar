...
/**
 * Condiciones form base class.
 *
 * @method Condiciones getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseCondicionesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('condiciones[%s]');
