...
/**
 * CargoAutoridades form base class.
 *
 * @method CargoAutoridades getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseCargoAutoridadesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'idcargoautoridad' => new sfWidgetFormInputHidden(),
    ...
    $this->widgetSchema->setNameFormat('cargo_autoridades[%s]');
