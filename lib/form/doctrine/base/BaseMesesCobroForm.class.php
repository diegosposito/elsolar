...
/**
 * MesesCobro form base class.
 *
 * @method MesesCobro getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseMesesCobroForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('meses_cobro[%s]');
