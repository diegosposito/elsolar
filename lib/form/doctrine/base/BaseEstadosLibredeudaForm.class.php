...
/**
 * EstadosLibredeuda form base class.
 *
 * @method EstadosLibredeuda getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseEstadosLibredeudaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('estados_libredeuda[%s]');
