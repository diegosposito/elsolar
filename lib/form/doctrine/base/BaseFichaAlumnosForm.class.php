...
/**
 * FichaAlumnos form base class.
 *
 * @method FichaAlumnos getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseFichaAlumnosForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ficha_alumnos[%s]');
