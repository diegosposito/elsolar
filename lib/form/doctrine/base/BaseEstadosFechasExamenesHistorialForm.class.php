...
/**
 * EstadosFechasExamenesHistorial form base class.
 *
 * @method EstadosFechasExamenesHistorial getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseEstadosFechasExamenesHistorialForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'idfechaexamen'       => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('FechasExamenes'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('estados_fechas_examenes_historial[%s]');
