 ...
 */
abstract class BaseTiposDocumentosForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'idtipodoc'   => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      'idtipodoc'   => new sfValidatorChoice(array('choices' => array($this->getObject()->get('idtipodoc')), 'empty_value' => $this->getObject()->get('idtipodoc'), 'required' => false)),
