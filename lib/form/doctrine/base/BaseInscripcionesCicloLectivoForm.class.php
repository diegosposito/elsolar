...
/**
 * InscripcionesCicloLectivo form base class.
 *
 * @method InscripcionesCicloLectivo getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseInscripcionesCicloLectivoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('inscripciones_ciclo_lectivo[%s]');
