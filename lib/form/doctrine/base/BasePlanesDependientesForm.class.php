...
/**
 * PlanesDependientes form base class.
 *
 * @method PlanesDependientes getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BasePlanesDependientesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'idplanestudiod' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'idplanestudiod' => new sfValidatorInteger(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('planes_dependientes[%s]');
