...
/**
 * EstadosAlumnoHistorial form base class.
 *
 * @method EstadosAlumnoHistorial getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseEstadosAlumnoHistorialForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('estados_alumno_historial[%s]');
