...
/**
 * DesignacionesMesas form base class.
 *
 * @method DesignacionesMesas getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseDesignacionesMesasForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'idtipodesignacionmesa' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TiposDesignacionesMesas'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('designaciones_mesas[%s]');
