...
/**
 * Horarios form base class.
 *
 * @method Horarios getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseHorariosForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tiporegistro'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'tiporegistro'  => new sfValidatorString(array('max_length' => 1)),
    ...
    $this->widgetSchema->setNameFormat('horarios[%s]');
