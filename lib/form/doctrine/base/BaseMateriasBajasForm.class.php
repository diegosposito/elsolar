...
/**
 * MateriasBajas form base class.
 *
 * @method MateriasBajas getObject() Returns the current form's model object
 *
 * @package    sig
 * @subpackage form
 ...
 */
abstract class BaseMateriasBajasForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('materias_bajas[%s]');
