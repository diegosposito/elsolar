<?php
class InscripcionesProfesorForm extends sfForm
{
  ...
  {         
	...
	$this->widgetSchema['idprofesor'] = new sfWidgetFormInputHidden();
	$this->widgetSchema['idfacultad'] = new sfWidgetFormInputHidden();
