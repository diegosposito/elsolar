...
/**
 * DocumentacionAlumnos filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseDocumentacionAlumnosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('documentacion_alumnos_filters[%s]');
