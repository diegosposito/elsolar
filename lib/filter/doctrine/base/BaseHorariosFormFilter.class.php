...
/**
 * Horarios filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseHorariosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tiporegistro'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'tiporegistro'  => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('horarios_filters[%s]');
