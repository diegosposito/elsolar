...
/**
 * MateriasEquivalencias filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseMateriasEquivalenciasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'idequivalencia'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('EquivalenciasAlumnos'), 'column' => 'idequivalencia')),
      ...
      'idestadoequivalencia' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('EstadosEquivalencias'), 'column' => 'idestadoequivalencia')),
    ...
    $this->widgetSchema->setNameFormat('materias_equivalencias_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                   => 'Number',
      'idequivalencia'       => 'ForeignKey',
      'idmateriaplan'        => 'ForeignKey',
      'idestadoequivalencia' => 'ForeignKey',
      'fecha'                => 'Date',
      'created_at'           => 'Date',
      'updated_at'           => 'Date',
