...
/**
 * CiclosLectivos filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseCiclosLectivosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'ciclo'      => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ciclos_lectivos_filters[%s]');
