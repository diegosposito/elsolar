...
/**
 * Empleados filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseEmpleadosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('empleados_filters[%s]');
