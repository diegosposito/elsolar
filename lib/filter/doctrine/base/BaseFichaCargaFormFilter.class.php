...
/**
 * FichaCarga filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseFichaCargaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ficha_carga_filters[%s]');
