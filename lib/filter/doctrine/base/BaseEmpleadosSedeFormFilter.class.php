...
/**
 * EmpleadosSede filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseEmpleadosSedeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('empleados_sede_filters[%s]');
