...
/**
 * LibredeudaTramites filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseLibredeudaTramitesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('libredeuda_tramites_filters[%s]');
