...
/**
 * AreasCarrera filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseAreasCarreraFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('areas_carrera_filters[%s]');
