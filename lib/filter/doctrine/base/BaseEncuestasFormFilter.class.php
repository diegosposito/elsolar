...
/**
 * Encuestas filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseEncuestasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('encuestas_filters[%s]');
