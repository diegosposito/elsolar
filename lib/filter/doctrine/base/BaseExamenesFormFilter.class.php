...
/**
 * Examenes filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseExamenesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'escrito'      => new sfWidgetFormFilterInput(),
      'oral'         => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'escrito'      => new sfValidatorPass(array('required' => false)),
      'oral'         => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('examenes_filters[%s]');
