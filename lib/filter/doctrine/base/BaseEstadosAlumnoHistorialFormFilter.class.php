...
/**
 * EstadosAlumnoHistorial filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseEstadosAlumnoHistorialFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('estados_alumno_historial_filters[%s]');
