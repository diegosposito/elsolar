...
/**
 * LogEventosDesignaciones filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseLogEventosDesignacionesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'sede'          => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'facultad'      => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'idfacultad'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      ...
      'destinatario'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('log_eventos_designaciones_filters[%s]');
