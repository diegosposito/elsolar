...
/**
 * MesesCobro filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseMesesCobroFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('meses_cobro_filters[%s]');
