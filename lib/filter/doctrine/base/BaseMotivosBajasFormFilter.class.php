...
/**
 * MotivosBajas filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseMotivosBajasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'idmotivo'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Motivos'), 'column' => 'idmotivo')),
    ...
    $this->widgetSchema->setNameFormat('motivos_bajas_filters[%s]');
