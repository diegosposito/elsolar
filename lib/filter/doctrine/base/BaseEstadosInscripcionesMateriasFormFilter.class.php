...
/**
 * EstadosInscripcionesMaterias filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseEstadosInscripcionesMateriasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('estados_inscripciones_materias_filters[%s]');
