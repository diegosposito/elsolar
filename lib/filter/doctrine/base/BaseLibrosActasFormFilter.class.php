...
/**
 * LibrosActas filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseLibrosActasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('libros_actas_filters[%s]');
