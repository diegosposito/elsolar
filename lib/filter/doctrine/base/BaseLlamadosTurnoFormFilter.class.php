...
/**
 * LlamadosTurno filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseLlamadosTurnoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('llamados_turno_filters[%s]');
