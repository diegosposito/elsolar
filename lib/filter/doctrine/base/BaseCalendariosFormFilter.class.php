...
/**
 * Calendarios filter form base class.
 *
 * @package    sig
 * @subpackage filter
 ...
 */
abstract class BaseCalendariosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('calendarios_filters[%s]');
