...
<br>
<div align="center">
<form action="<?php echo url_for('expedientes/buscar') ?>" method="post">
  <table cellspacing="0" class="stats" width="80%">
      <?php echo $form->renderGlobalErrors() ?>
      <tr>
        <td width="20%"><b><?php echo $form['idtitulo']->renderLabel() ?></b></td>
        <td>
	  ...
	  <tbody>
	    ...
	    <tr class="fila_<?php echo $i%2 ; ?>">
	      ...
	      <td width="10%" align="center">
			<form name="form_<?php echo $form->getValue('idtitulo'); ?>" method="post" action="<?php echo url_for('expedientes/veregresado') ?>">  
				<input type="hidden" name="idtitulo" value="<?php echo $form->getValue('idtitulo'); ?>">
