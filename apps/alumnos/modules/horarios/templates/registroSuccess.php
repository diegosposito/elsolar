...
<table cellspacing="0" class="stats">
    <thead>
      <tr>
        <td width="37%" align="center" class="hed">Persona</td>
        <td width="10%" align="center" class="hed">Tipo</td>
        <td width="23%" align="center" class="hed">Fecha/Hora</td>
        <td width="23%" align="center" class="hed">Observac.</td>
    ...
    <tbody>
      ...
      <tr class="fila_<?php echo $i%2 ; ?>">
        <td style="height:30px;width='37%'" align="left"><a href="#" title="<?php echo $horarios->getPersonas()->getHorarios() ?>"> <?php echo $horarios->getPersonas()->getApellido().', '.$horarios->getPersonas()->getNombre() ?> </a></td>
        <td style="height:30px;width='10%'" align="left"><?php echo $horarios->getTiporegistro()==1 ? 'ENTRADA' : 'SALIDA' ?></td>
        <td style="height:30px;width='23%'" align="left"><?php echo date('d-m-Y H:i:s', strtotime($horarios->getCreatedAt())) ?></td>
        <td style="height:30px;width='23%'" align="center">
