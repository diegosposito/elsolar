...
$(document).ready(function(){
    ...
    $.post("<?php echo url_for('mesasexamenes/obtenermateriasplanes'); ?>",
		{ idplanestudio: <?php echo $idplanestudio; ?> },
		function(data){
			$('#materiasplanes').html(data);
		}
	);	
	<?php } ?>
    ...
    $('#botonCrear').click(function() {
    	...
    	if(validado == true) {
    	    ...
    	    $.post("<?php echo url_for('mesasexamenes/crearmasivo'); ?>", 
				$('#formCrear').serialize(),
    			function(data){
					alert(data);
				}				
...
<form action="" method="post" id="formCrear" >
  ...
  <tr>
    <td colspan="3" align="center">
		<div id="materiasplanes" align="center"></div>
    </td>
  </tr>          
    </tbody>      
  </table>
