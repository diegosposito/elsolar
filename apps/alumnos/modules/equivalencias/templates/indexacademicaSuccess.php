...
<table width="100%" class="stats" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
	  ...
	  <td align="center">
	  	<?php if ($equivalencias_alumnos->getNroresolucion()=="") { ?>
      	<input type="button" value="Registrar" onclick="location.href='<?php echo url_for('equivalencias/registrarequivalencia?idequivalencia='.$equivalencias_alumnos->getIdequivalencia()) ?>'">
      	<?php } ?>
