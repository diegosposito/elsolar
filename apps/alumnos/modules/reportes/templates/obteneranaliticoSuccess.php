...
<?php 
   foreach($planes as $plan){
      ...
      <td><a href="<?php echo url_for('personas/getanalitico?idc='.$plan['idCarrera']."&idp=".$idp) ?>">Descargar</a></td>
      </tr> 
  <?php } ?>
</table>
<br />
...
if ($analitico){ ?> 
  ...
  <?php 
    ...
    <?php }?>    	 
     ...
     <td><?php echo $analit['ida'] ?></td>
     <td><?php echo $analit['idfe'] ?></td>
     <td><?php echo $analit['idm'] ?></td>
      </tr>
  <?php 
...
if ($analiticoalumno){ ?> 
  ...
  <thead>
    <tr>
      ...
      <td class="hed">Curso</td>
      <td class="hed">idA</td>
      <td class="hed">idFE</td>
    </tr>
  </thead>
  <?php 
     $arrYears = array (1 => "Primer año", 2 => "Segundo año", 3 => "Tercer año", 4 => "Cuarto año",  5 => "Quinto año", 6 => "Sexto año");
     $anioactual = 0; $promedio = 0; $cantidad = 0; $canti = 0;
     foreach($analiticoalumno as $analit){ 
         if ($anioactual != $analit['curso']){ 
           $anioactual = $analit['curso']; ?>
           <tr bgcolor="#666666"><td colspan="9" align="center"><b><?php echo $arrYears[$anioactual] ?></b></td></tr>
    <?php }?>    	 
   	  <tr>
      <td><?php echo $analit['nombre'] ?></td>
      <td><?php echo $analit['promedio'] ?></td>
      <td><?php echo $analit['libro'] ?></td>
      <td><?php echo $analit['folio'] ?></td>
      <td><?php echo $analit['fecha'] ?></td>
      <td><?php echo $analit['Condicion'] ?></td>
  ...
  <?php 
         if ($analit['promedio']!="" and $analit['promedio']>=4  and $analit['promedio']!='U'){
             $promedio+=$analit['promedio']; 
             $canti++;
         }   
         $cantidad++;
     } ?>
 <tr><td  colspan="7"><strong>Promedio:</strong> <?php echo number_format($promedio/$canti, 2).' - Sobre '.$canti.' materias Aprobadas'; ?></td></tr>
 <tr><td  colspan="7"><strong>Cant. Materias:</strong> <?php echo $cantidad ?></td></tr>
 </table>
