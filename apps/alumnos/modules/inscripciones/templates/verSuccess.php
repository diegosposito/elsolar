...
<table cellspacing="0" class="stats" width="100%">
  <tr>
    <td colspan="2"><b>Asignatura: <?php echo $materiaplan; ?></b></td>
  </tr>
  <tr>
    <td colspan="2"><b>Alumno: <?php echo $alumno->getPersonas(); ?></b></td>
  </tr>
  <tr>
    <td colspan="2" align="center">
		<table width="100%" cellspacing="0" class="stats">
		  <thead>
		    <tr>
		      <td class="hed" align="center" width="5%"></td>
		      <td class="hed" align="center" width="30%">Fecha</td>
		      <td class="hed" align="center" width="30%">Condición</td>
		      <td class="hed" align="center" width="30%">Libro</td>
		      <td class="hed" align="center" width="15%">Folio</td>
		  ...
		  <tbody>
		    ...
		    <tr>
		      <td align="center">
		      	<?php echo $examen['idmesaexamen']; ?>
		      </td>
		      <td align="center">
		      <?php 
				$arr = explode('-', $examen['fecha']);
				$fecha = $arr[2]."-".$arr[1]."-".$arr[0]; 
			  ?>		      
		      <?php echo $fecha." - ".$examen['hora']; ?>
		      </td>
		      <td align="center"><?php echo $examen['condicion']; ?></td>
		      <td align="center"><?php echo $examen['libro']; ?></td>
		      <td align="center"><?php echo $examen['folio']; ?></td>
		      <td align="center"><?php echo $examen['promedio']; ?></td>
		    </tr>
		    <?php endforeach; ?>	
		    <?php } else { ?>
			    <tr>
