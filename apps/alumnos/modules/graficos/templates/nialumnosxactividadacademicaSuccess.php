...
$(document).ready(function() {
    ...
    $('#seleccionar').change(function() {
        $.post("<?php echo url_for("graficos/nialumnosxactividadacademicagraf")?>", 
            $(this).serialize(),
            function(data) {
                $('#result').html(data);
...
<h1>Evolución de Alumnos según Actividad Academica</h1> 
<br>
<form method="post" action="nialumnosxactividadacademicagraf" id="form1" name="form1" >
