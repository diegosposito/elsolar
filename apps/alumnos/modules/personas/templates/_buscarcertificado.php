...
<br>
<div align="center">
<form action="<?php echo url_for('personas/buscarcertificado') ?>" method="post">
  <table cellspacing="0" class="stats" width="60%">
	...
	<tr>
		...
		<td colspan="2" align="center"><input type="submit" value="Buscarcertificado" /></td>
    </tr>    
  </table>
</form>
...
<?php if (count($resultado) > 0){ ?>		    	   	
	<table cellspacing="0" class="stats">
      <tr>
        <td><textarea readonly id="comentario" name="coment" cols="44" ><textarea id="comentario" name="coment" cols="44" >Hola a todos</textarea>
        </td>
      </tr>
	    <tr>
