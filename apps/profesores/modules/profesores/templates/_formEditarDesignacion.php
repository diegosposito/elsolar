...
<form action="<?php echo url_for('designaciones/editar') ?>" method="post" id="formDesignar">
<input type="hidden" id="idprofesor" name="idprofesor" value="<?php echo $idprofesor; ?>">
<input type="hidden" id="iddesignacion" name="iddesignacion" value="<?php echo $iddesignacion; ?>">
  <table cellspacing="0" class="stats" width="100%">
    <tfoot>
      <tr>
        <td colspan="4" align="center">
          <?php echo $form->renderHiddenFields(false) ?>    
          <input type="submit" value="Editar Designación" id="botonDesignar" />
        </td>
      </tr>
    </tfoot>
    <tbody>
