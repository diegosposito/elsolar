<?php if (count($resultado) > 0){ ?>              
  <table cellspacing="0" class="stats">
      ...
      <tr>
        <td width="8%" align="center" class="hed">Sede</td>
        <td width="13%" align="center" class="hed">Carrera-Plan</td>
        <td width="15%" align="center" class="hed">Materia</td>
        <td width="15%" align="center" class="hed">Cargo docente</td>
        <td width="11%" align="center" class="hed">Fec.Inicio</td>
        <td width="11%" align="center" class="hed">Fec.Fin</td>
    ...
    <tbody>
      ...
      <tr>
        <td width="8%"><?php echo $item['sedeabv'] ?></td>
        <td width="13%"><?php echo $item['carreraplan'] ?></td>
        <td width="15%"><?php echo $item['materia'] ?></td>
        <td width="15%"><?php echo $item['tipo'].' ('.$item['categoria'].')' ?></td>
        <td width="11%"><?php echo $item['inicioformat'] ?></td>
        <td width="11%"><?php echo $item['finformat'] ?></td>
        ...
        <?php switch ($item['idestadodesignacion']) {
            case 1: ?>
                ...
                break;
            case 2: ?>
                <td bgcolor="#ACFA58" width="10%"><?php echo $item['estadodesignacion'] ?></td>
                <?php
                break;
            case 3: ?>
                <td bgcolor="#F7FE2E" width="10%"><?php echo $item['estadodesignacion'] ?></td>
                <?php
                break;
            case 4: ?>
                <td bgcolor="#848484" width="10%"><?php echo $item['estadodesignacion'] ?></td>
                <?php
                break;        
            case 5: ?>
                <td bgcolor="#088A08" width="10%"><?php echo $item['estadodesignacion'] ?></td>
                <?php
                break;
        } ?>
