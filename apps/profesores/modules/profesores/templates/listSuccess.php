...
<?php echo link_to('Primeras ', 'profesores/list?page='.$pager->getFirstPage(),'class="pager"') ?>
<?php echo link_to('Anterior ', 'profesores/list?page='.$pager->getPreviousPage(),'class="pager"' ) ?>
<?php $links = $pager->getLinks(); foreach ($links as $page): ?>
<?php echo ($page == $pager->getPage()) ? $page : link_to($page, 'profesores/list?page='.$page,'class="pager"') ;?>
<?php if ($page != $pager->getCurrentMaxLink()): ?> <?php endif ?>
<?php endforeach ?>
<?php echo link_to(' Siguiente ', 'profesores/list?page='.$pager->getNextPage(),'class="pager"') ?>
<?php echo link_to('Ultimas ', 'profesores/list?page='.$pager->getLastPage(),'class="pager"') ?>
<?php } ?></div>
