...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/newp/elsolar/log/alumnos_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/newp/elsolar/cache/alumnos/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/newp/elsolar/apps/alumnos/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/newp/elsolar/cache/alumnos/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/newp/elsolar/apps/alumnos/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'tramitesalumnos@nada.edu.ar',
      'password' => '522ucu2013',
    ),
  ),
))));
