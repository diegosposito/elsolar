...
// date: 2016/09/01 09:32:14
  ...
  'cache_dir' => '/home/projects/circulo/cache/alumnos/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/projects/circulo/apps/alumnos/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/projects/circulo/cache/alumnos/prod/template',
  'lifetime' => 86400,
  'prefix' => '/home/projects/circulo/apps/alumnos/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'tramitesalumnos@aelf.edu.ar',
      'password' => '522ucu2013',
    ),
  ),
))));
